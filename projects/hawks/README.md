...
```bash
   ./hawks
```
6. Edit 'input.txt' to try different test cases provided in 'test cases' folder. It's suggested to copy script program code & paste into 'input.txt' file to run. 
